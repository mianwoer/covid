...
class Fxdq(models.Model):
    dangerlevel = models.TextField(db_column='dangerLevel', blank=True, null=True)  # 风险等级
    provinceid = models.TextField(db_column='provinceId', blank=True, null=True)  # 省（或直辖市）编号
    provincename = models.TextField(db_column='provinceName', blank=True, null=True)  # 省（或直辖市）.
    cityname = models.TextField(db_column='cityName', blank=True, null=True)  # 城市（或直辖市下属区）.
    areaname = models.TextField(db_column='areaName', blank=True, null=True)  # 区域.
