var localhost = "http://127.0.0.1:9000/" // API路由地址
...
function getdata(){
    $.ajax({
        type: "GET",
        url: localhost + "covid_ksh/v1/chinayq/?p=" + rand,
        dataType: "json",
...
function gryq() {
    $.ajax({
        type: "GET",
        url: localhost + "covid_ksh/v1/xyqz/",
        dataType: "json",
        success: function (result) {
...
function Zgdt() {
    $.ajax({
        type: "GET",
        url: localhost + "covid_ksh/v1/zgdt/?p=" + rand,
        dataType: "json",
        success: function (result) {
            // console.log(result)
            var options = result.data;
...
function Yqbt() {
    $.ajax({
        type: "GET",
        url: localhost + "covid_ksh/v1/yqbt/",
        dataType: "json",
        success: function (result) {
            // console.log(result)
            var options = result.data;
...
function gfx1() {
    $.ajax({
        type: "GET",
        url: localhost + "covid_ksh/v1/gfx/?p="+rand,
        dataType: "json",
        success: function (result) {
            var options = result.data;
...
function zfx1() {
    $.ajax({
        type: "GET",
        url: localhost + "covid_ksh/v1/zfx/?p="+rand,
        dataType: "json",
        success: function (result) {
            var options = result.data;
...
function getssbb() {
  $.ajax({
      type: "GET",
      url: localhost + "covid_ksh/v1/ssrd/",
      dataType: "json",
      success: function (result) {
          result = result.data
...
function fxdqlb1() {
    $.ajax({
        type: "GET",
        url: localhost + "covid_ksh/v1/fxdq/?p=" + rand,
        dataType: "json",
        success: function (result) {
            // console.log(result)
            var gaddress = ''
